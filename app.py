...
from database import (
    ...
    get_products, update_product, get_categories, get_units
)
import re
...
def display_chatbot():
    """Display the inventory assistant chatbot"""
    ...
    if prompt := st.chat_input("Ask me anything about your inventory..."):
        ...
        context = f"""You are an inventory management assistant. Here is the current inventory data:
        
        {products_df.to_string()}
        
        Please provide helpful and accurate responses based on this data."""
